var U = function(U) {
    var i, manifest = [ {
        ...
        src: "img/mountain_landscape_23.png",
        id: "tilesetSheet"
    }, {
        src: "data/mountain.json",
        id: "mountain.json"
...
U.Map = function(toolkit, undefined) {
    var engine = function() {
        var data, layers, tilesetSheet, layerContainer;
        ...
        Layer.prototype = {
            init: function(layerData) {
                ...
                for (i = layerData.data.length - 1; i >= 0; i--) {
                    ...
                    tile.appendToLayer(this).putTo(x, y);
                }
            },
        ...
        Tile.prototype = {
            ...
            appendToLayer: function(layer) {
                layer.getContainer().addChild(this.sprite);
                this.parent = layer;
                return this;
            },
            getSprite: function() {
        ...
        createLayers = function() {
            var i, l, layer, layersArray = data.layers;
        ...
        return {
            ...
            scrollTo: function(x, y) {
                var viewportWidth = U.Game.getViewportWidth(), viewportHeight = U.Game.getViewportHeight(), scrollableWidth = Math.max(0, layers[0].getWidthInPixels() - viewportWidth), scrollableHeight = Math.max(0, layers[0].getHeightInPixels() - viewportHeight);
            ...
            centerTo: function(x, y) {
                var viewportWidth = U.Game.getViewportWidth(), viewportHeight = U.Game.getViewportHeight(), scrollX = x - Math.round(viewportWidth / 2), scrollY = y - Math.round(viewportHeight / 2);
...
U.Objects.Grant = function(monster) {
    ...
    p.Monster_initialize = p.initialize;
