    ...
    var engine = function() {
        ...
        return {
            ...
            scrollTo: function(x, y) {
                var viewportWidth = U.Game.getViewportWidth(), viewportHeight = U.Game.getViewportHeight(), scrollableWidth = Math.max(0, layers[0].getWidthInPixels() - viewportWidth), scrollableHeight = Math.max(0, layers[0].getHeightInPixels() - viewportWidth);
