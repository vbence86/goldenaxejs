...
U.Map = function(toolkit) {
    var engine = function() {
        var data, tilesetSheet, setData = function(json) {
            data = json;
        };
        ...
        createLayerContainers = function() {
            var layers = data.layers, container;
        ...
        removeTileElementXY = function() {
            var args = Array.prototype.slice.call(arguments), layer = args[0], index;
            if (!layer) {
                return;
            }
            if (args.length === 2) {
    ...
    return {
        ...
        appendTo: function(stage) {
            engine.generate().appendLayersToStage(stage);
        },
        remove: function(x, y) {
            engine.remove(x, y);
        }
